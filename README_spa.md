...
* **Por qué los códigos de error de `recovery.py` coinciden con el
  vocabulario del adaptador MCU documentado en el manual de arquitectura
  BIBLIA.** `INVALID_STATE`/`OUT_OF_RANGE`/`ESTOP_ACTIVE`/
