...
* **Perché i codici di errore di `recovery.py` corrispondono al
  vocabolario dell'adattatore MCU documentato nel manuale di
  architettura BIBLIA.** `INVALID_STATE`/`OUT_OF_RANGE`/`ESTOP_ACTIVE`/
